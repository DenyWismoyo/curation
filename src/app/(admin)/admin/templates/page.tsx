...
import { TabGeneral } from '@/features/admin/components/template-builder/TabGeneral'
import { TabAIConfig } from '@/features/admin/components/template-builder/TabAIConfig'
import { TabAdaptive } from '@/features/admin/components/template-builder/TabAdaptive'
import { TabFormBuilder } from '@/features/admin/components/template-builder/TabFormBuilder'
import { AdminTemplatePreview } from '@/features/admin/components/AdminTemplatePreview'
import { TabLogs } from '@/features/admin/components/template-builder/TabLogs'
