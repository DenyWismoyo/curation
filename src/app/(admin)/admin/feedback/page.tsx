  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 pb-20">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-4">
        ...
        {/* Summary Card */}
        <div className="flex items-center gap-4 bg-white p-4 rounded-2xl ring-1 ring-slate-200/80 shadow-xs shrink-0">
          <div className="w-12 h-12 bg-amber-50 rounded-xl flex items-center justify-center text-amber-500 ring-1 ring-amber-100">
      ...
      {feedbacks.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
          {feedbacks.map((item) => (
            <Card
              key={item.id}
              className="p-6 bg-white rounded-3xl border-none ring-1 ring-slate-200 shadow-sm flex flex-col hover:shadow-md transition-shadow"
            >
