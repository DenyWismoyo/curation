...
export default function B2BAnalyticsPage() {
  ...
  if (isLoadingOrgs) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center bg-muted text-muted-foreground">
        <Loader2 size={36} className="text-indigo-600 dark:text-indigo-400 animate-spin mb-3" />
        <p className="text-muted-foreground font-medium">Memuat Dasbor B2B BI Analytics...</p>
      </div>
    );
  }

  return (
    <div className="p-6 sm:p-10 space-y-8 bg-muted text-muted-foreground min-h-screen">
      
      {/* HEADER DASBOR */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 card-solid p-6 sm:p-8 rounded-3xl ring-1 ring-border shadow-sm">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 ring-1 ring-indigo-100 text-xs font-bold uppercase tracking-wider mb-2">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <div className="flex flex-col">
            ...
            <select
              ...
              className="bg-muted text-muted-foreground ring-1 ring-border border-none font-bold text-foreground text-sm rounded-xl px-4 py-2.5 focus:ring-2 focus:ring-indigo-500 min-w-[240px]"
            >
          ...
          <Button 
            ...
            variant="outline" 
            size="icon"
            className="mt-5 rounded-xl h-10 w-10 border-border text-muted-foreground hover:text-indigo-600 dark:text-indigo-400"
      ...
      {isLoadingAnalytics ? (
        <div className="card-solid p-12 rounded-3xl ring-1 ring-border text-center flex flex-col items-center">
          <Loader2 size={32} className="text-indigo-600 dark:text-indigo-400 animate-spin mb-3" />
          <p className="text-muted-foreground font-medium">Menyusun laporan makro kohort...</p>
        </div>
      ) : !analytics || analytics.totalAssessments === 0 ? (
        <div className="card-solid p-12 rounded-3xl ring-1 ring-border text-center max-w-lg mx-auto space-y-4">
          <Building2 size={48} className="text-slate-300 mx-auto" />
          <h3 className="text-xl font-bold text-foreground">Belum Ada Data Asesmen Kohort</h3>
          <p className="text-muted-foreground text-sm">
            Organisasi <strong className="text-foreground">{selectedOrgId}</strong> belum memiliki peserta yang menyelesaikan asesmen.
          </p>
        </div>
      ) : (
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <div className="card-solid p-6 rounded-3xl ring-1 ring-border shadow-sm flex items-center gap-4">
              ...
              <div>
                ...
                <h3 className="text-3xl font-black text-foreground mt-0.5">{analytics.totalAssessments}</h3>
              </div>
            </div>
            ...
            <div className="card-solid p-6 rounded-3xl ring-1 ring-border shadow-sm flex items-center gap-4">
              ...
              <div>
                ...
                <h3 className="text-3xl font-black text-foreground mt-0.5">{analytics.averageScore}<span className="text-sm font-bold text-slate-400">/100</span></h3>
              </div>
            </div>
            ...
            <div className="card-solid p-6 rounded-3xl ring-1 ring-border shadow-sm flex items-center gap-4">
              ...
              <div>
                ...
                <h3 className="text-3xl font-black text-emerald-600 dark:text-emerald-400 mt-0.5">{analytics.readinessDistribution.highPct}%</h3>
              </div>
            </div>
            ...
            <div className="card-solid p-6 rounded-3xl ring-1 ring-border shadow-sm flex items-center gap-4">
              ...
              <div>
                ...
                <h3 className="text-3xl font-black text-foreground mt-0.5">{analytics.dimensionAverages.dataQuality}<span className="text-sm font-bold text-slate-400">/100</span></h3>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="card-solid p-6 sm:p-8 rounded-3xl ring-1 ring-border shadow-sm flex flex-col justify-between">
              <div>
                <h3 className="text-lg font-black text-foreground mb-1 flex items-center gap-2">
                  <BarChart3 size={18} className="text-indigo-600 dark:text-indigo-400" /> Distribusi Zonasi Kesiapan Kohort
                </h3>
            ...
            <div className="card-solid p-6 sm:p-8 rounded-3xl ring-1 ring-border shadow-sm flex flex-col justify-between">
              <div>
                <h3 className="text-lg font-black text-foreground mb-1 flex items-center gap-2">
                  <Sparkles size={18} className="text-indigo-600 dark:text-indigo-400" /> Radar 4 Dimensi Kinerja Kohort
                </h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {/* TOP CRITICAL RISKS */}
            <div className="bg-rose-50 dark:bg-rose-500/10/50 p-6 sm:p-8 rounded-3xl ring-1 ring-rose-200 dark:ring-rose-500/20/80 shadow-sm">
              <h3 className="text-lg font-black text-rose-900 mb-1 flex items-center gap-2">
                <ShieldAlert size={20} className="text-rose-600 dark:text-rose-400" /> Top 5 Hambatan/Risiko Kritis Dominan
              </h3>
              <p className="text-xs text-rose-700 dark:text-rose-300 font-medium mb-6">
              ...
              <div className="space-y-4">
                {analytics.topCriticalRisks.length === 0 ? (
                  ...
                  analytics.topCriticalRisks.map((item, idx) => (
                    <div key={idx} className="card-solid p-4 rounded-2xl ring-1 ring-rose-100 shadow-sm flex items-center justify-between gap-4">
                      <div className="flex items-center gap-3">
                        <span className="w-6 h-6 rounded-full bg-rose-100 text-rose-700 dark:text-rose-300 font-black text-xs flex items-center justify-center shrink-0">
                          {idx + 1}
                        </span>
                        <span className="text-xs font-bold text-foreground">{item.risk}</span>
                      </div>
                      <span className="text-xs font-mono font-black text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-500/10 px-2.5 py-1 rounded-lg shrink-0">
            ...
            <div className="bg-indigo-50 dark:bg-indigo-500/10/50 p-6 sm:p-8 rounded-3xl ring-1 ring-indigo-200 dark:ring-indigo-500/20/80 shadow-sm">
              <h3 className="text-lg font-black text-indigo-900 mb-1 flex items-center gap-2">
                <Globe size={20} className="text-indigo-600 dark:text-indigo-400" /> Rekomendasi Fokus Intervensi Prioritas
              </h3>
              <p className="text-xs text-indigo-700 dark:text-indigo-300 font-medium mb-6">
              ...
              <div className="space-y-4">
                {analytics.topRecommendedFocus.length === 0 ? (
                  ...
                  analytics.topRecommendedFocus.map((item, idx) => (
                    <div key={idx} className="card-solid p-4 rounded-2xl ring-1 ring-indigo-100 shadow-sm flex items-center justify-between gap-4">
                      <div className="flex items-center gap-3">
                        <span className="w-6 h-6 rounded-full bg-indigo-100 text-indigo-700 dark:text-indigo-300 font-black text-xs flex items-center justify-center shrink-0">
                          {idx + 1}
                        </span>
                        <span className="text-xs font-bold text-foreground">{item.focus}</span>
                      </div>
                      <span className="text-xs font-mono font-black text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-500/10 px-2.5 py-1 rounded-lg shrink-0">
                        {item.count} peserta ({item.pct}%)
                      </span>
                    </div>
                  ))
          ...
          <div className="card-solid p-6 sm:p-8 rounded-3xl ring-1 ring-border shadow-sm">
            <h3 className="text-lg font-black text-foreground mb-4">Daftar Peserta Kohort ({analytics.participants.length})</h3>
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-border text-[10px] uppercase font-black tracking-widest text-slate-400">
                ...
                <tbody className="divide-y divide-slate-100 text-xs font-medium text-slate-700">
                  {analytics.participants.map((p) => (
                    <tr key={p.id} className="hover:bg-muted text-muted-foreground transition-colors">
                      <td className="py-3.5 px-2 font-bold text-foreground">{p.namaUsaha}</td>
                      <td className="py-3.5 px-2 text-muted-foreground">{p.userEmail}</td>
                      <td className="py-3.5 px-2 uppercase font-semibold text-indigo-600 dark:text-indigo-400">{p.trackType}</td>
                      <td className="py-3.5 px-2 font-black">
                        <span className={`px-2.5 py-1 rounded-lg ${p.score >= 75 ? 'bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400' : p.score >= 60 ? 'bg-amber-50 dark:bg-amber-500/10 text-amber-600 dark:text-amber-400' : 'bg-rose-50 dark:bg-rose-500/10 text-rose-600 dark:text-rose-400'}`}>
                          {p.score}
                        </span>
                      </td>
          ...
          <div className="card-solid p-6 sm:p-8 rounded-3xl ring-1 ring-border shadow-sm space-y-6">
            <div>
              <h3 className="text-lg font-black text-foreground mb-1 flex items-center gap-2">
                <Palette size={20} className="text-indigo-600 dark:text-indigo-400" /> Konfigurasi White-Labeling & Webhooks
              </h3>
              <p className="text-xs text-muted-foreground font-medium">
                Atur tema identitas merek dan endpoint integrasi webhook untuk organisasi <strong className="text-foreground">{selectedOrgId}</strong>.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* WHITE-LABELING */}
              <div className="space-y-4 bg-muted text-muted-foreground p-5 rounded-2xl border border-border">
                ...
                <div>
                  <label className="text-xs font-bold text-muted-foreground mb-1 block">URL Logo Organisasi</label>
                  <Input 
                    value={logoUrl} 
                    onChange={(e) => setLogoUrl(e.target.value)} 
                    placeholder="https://domain.com/logo.png" 
                    className="card-solid text-xs"
                  />
                </div>

                <div>
                  <label className="text-xs font-bold text-muted-foreground mb-1 block">Warna Utama (Hex Color)</label>
                  <div className="flex gap-2">
                    ...
                    <Input 
                      ...
                      onChange={(e) => setPrimaryColor(e.target.value)} 
                      placeholder="#4f46e5" 
                      className="card-solid text-xs font-mono uppercase flex-1"
                    />
                  </div>
                </div>

                <div>
                  <label className="text-xs font-bold text-muted-foreground mb-1 block">Judul Custom Header</label>
                  <Input 
                    value={customTitle} 
              ...
              <div className="space-y-4 bg-muted text-muted-foreground p-5 rounded-2xl border border-border">
                ...
                <div>
                  <label className="text-xs font-bold text-muted-foreground mb-1 block">Webhook Endpoint URL</label>
                  <Input 
                    value={webhookUrl} 
                ...
                <div>
                  <label className="text-xs font-bold text-muted-foreground mb-1 block">Webhook Signing Secret</label>
                  <Input 
                    type="password" 
                    value={webhookSecret} 
                    onChange={(e) => setWebhookSecret(e.target.value)} 
                    placeholder="whsec_xxxxxxxx" 
                    className="card-solid text-xs font-mono"
                  />
                </div>
