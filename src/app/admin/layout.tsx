...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    // 1. KOTAK UTAMA: Memastikan tinggi persis 1 layar penuh (h-screen) dan berdampingan (flex)
    <div className="flex h-screen overflow-hidden bg-slate-50 font-sans text-slate-900">
      
      {/* ==================================================== */}
      {/* 2A. MOBILE SIDEBAR (Drawer melayang, hanya di HP)    */}
      {/* ==================================================== */}
      {isMobileMenuOpen && (
      ...
      {/* ==================================================== */}
      {/* 2B. DESKTOP SIDEBAR (Berdampingan fisik, bukan melayang) */}
      {/* ==================================================== */}
      <aside 
      ...
      {/* ==================================================== */}
      {/* 3. KONTEN UTAMA (Sisa layar, men-scroll isinya sendiri) */}
      {/* ==================================================== */}
