...
export default function CryptoRiskDisclosurePage() {
  return (
    <div className="min-h-screen bg-muted text-muted-foreground text-foreground py-12 px-4 sm:px-6 lg:px-8 font-sans selection:bg-indigo-500/30">
      <div className="max-w-3xl mx-auto card-solid p-8 sm:p-12 rounded-[2rem] shadow-xl ring-1 ring-border">
        <h1 className="text-3xl sm:text-4xl font-black mb-2 text-indigo-600 dark:text-indigo-400 tracking-tight">Pernyataan Risiko Kripto</h1>
        <p className="text-sm text-muted-foreground font-medium mb-8">Pembaruan Terakhir: {new Date().toLocaleDateString('id-ID')}</p>
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <h2 className="text-xl font-bold mt-8 mb-4 text-foreground">1. Risiko Volatilitas Harga</h2>
          <p>
          ...
          <h2 className="text-xl font-bold mt-8 mb-4 text-foreground">2. Risiko Regulasi</h2>
          <p>
          ...
          <h2 className="text-xl font-bold mt-8 mb-4 text-foreground">3. Sifat Informasi</h2>
          <p>
          ...
          <h2 className="text-xl font-bold mt-8 mb-4 text-foreground">4. Risiko Teknologi</h2>
          <p>
          ...
          <div className="mt-10 p-5 bg-rose-50 dark:bg-rose-500/10 border border-rose-200 dark:border-rose-500/20 rounded-xl">
            <p className="text-sm font-bold text-rose-700 dark:text-rose-300 mb-0">
