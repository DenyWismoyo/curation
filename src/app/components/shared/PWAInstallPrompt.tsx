  ...
  return (
    <AnimatePresence>
      {showPrompt && !isStandalone && (
        ...
        >
          <div className="bg-white/90 backdrop-blur-2xl border border-slate-200/60 p-4 rounded-[1.25rem] shadow-2xl shadow-slate-900/10 relative overflow-hidden group flex items-center gap-4">
            ...
            <div className="flex-1 pr-6 relative z-10">
              ...
              <p className="text-[10px] font-bold text-slate-500 mb-2.5">
                {isIOS ? 'Ketuk pasang untuk panduan iOS.' : 'Akses lebih cepat & tanpa batas.'}
              </p>
