          ...
          <View style={[styles.section, { marginTop: role === 'user' ? 32 : 0 }]} wrap={false}>
            ...
            <View style={styles.grid2Col}>
              <View style={styles.colHalf}>
                ...
                <Text style={styles.value}>{aiResult.fileAnalysisInsights.documentQuality}</Text>
              </View>
              {aiResult.fileAnalysisInsights.discrepancies && (
                <View style={styles.colHalf}>
                  <Text style={[styles.label, { color: '#000000' }]}>Data Discrepancies</Text>
                  <Text style={[styles.value, { fontWeight: 700 }]}>{aiResult.fileAnalysisInsights.discrepancies}</Text>
                </View>
              )}
            </View>
            ...
            {aiResult.fileAnalysisInsights.keyFindingsFromFiles && (
              <View>
                ...
                {aiResult.fileAnalysisInsights.keyFindingsFromFiles.map((find: string, idx: number) => (
                  <View key={idx} style={styles.bulletRow}><Text style={styles.bulletDot}>■</Text><Text style={styles.bulletText}>{find}</Text></View>
                ))}
              </View>
            )}
