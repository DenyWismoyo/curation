// src/app/components/curation/FeedbackModal.tsx
'use client';
  ...
  const handleSubmit = async () => {
    ...
    try {
      await addDoc(collection(db, 'feedbacks'), {
        ...
        status: 'unread' // untuk dashboard admin
      });
    ...
    <AnimatePresence>
      ...
      >
        <motion.div 
          ...
          className="bg-white w-full max-w-md rounded-[2rem] shadow-2xl overflow-hidden relative ring-1 ring-slate-200"
        >
          {/* Header */}
          ...
          <div className="p-6 sm:p-8 space-y-6 bg-white">
            ...
            <div className="space-y-3">
              ...
              <Textarea 
                ...
                className="bg-slate-50 border-slate-200 rounded-xl resize-none h-32 focus-visible:ring-indigo-500 text-sm font-medium"
              />
            </div>
