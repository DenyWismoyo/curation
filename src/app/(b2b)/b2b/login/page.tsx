      ...
      <div className="w-full max-w-md rounded-[2rem] card-solid shadow-2xl ring-1 ring-border overflow-hidden">
        ...
        <div className="p-7 space-y-4">
          ...
          <div className="rounded-xl bg-muted text-muted-foreground p-4 ring-1 ring-border text-xs text-muted-foreground leading-relaxed">
            <p className="font-black text-foreground uppercase tracking-[0.14em] mb-1 flex items-center gap-1"><ShieldCheck className="w-3.5 h-3.5" /> Kebijakan B2B</p>
            <p>Dengan login, Anda menyetujui ketentuan penggunaan dashboard B2B dan pembatasan akses berbasis scope organisasi.</p>
            <Link href="/docs/b2b-ketentuan-benefit.md" className="text-indigo-600 dark:text-indigo-400 font-bold mt-2 inline-block">Baca ketentuan & benefit B2B</Link>
          </div>
        </div>
      </div>
    </div>
