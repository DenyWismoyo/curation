...
function ScoreBadge({ score }: { score?: number }) {
  ...
  return (
    <span
      className={`inline-flex items-center px-2.5 py-1 rounded-xl text-sm font-black ring-1 ${color}`}
    >
      {score}
    </span>
  )
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 font-medium">
                Timeline & analisis perjalanan asesmen
              </p>
            </div>
          </div>
        </div>
        ...
        {records.length === 0 ? (
          <div className="bg-white rounded-3xl p-16 text-center ring-1 ring-slate-200 shadow-sm">
            ...
            <p className="text-sm text-slate-500 max-w-sm mx-auto mb-6">
              Mulai asesmen pertama untuk melihat grafik progres dan analisis
              perjalanan Anda.
            </p>
            <Button
          ...
          <>
            ...
            {scores.length >= 2 && (
              <div
                className={`flex items-center gap-3 px-5 py-4 rounded-2xl font-bold text-sm ${
                  improvement > 0
                ...
                <div className="space-y-4">
                  {[...records].reverse().map((rec, i) => (
                    ...
                    >
                      {/* dot */}
                      <div
                        className={`relative z-10 w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 shadow-sm border-2 ${
            ...
            <div className="bg-gradient-to-br from-indigo-600 to-purple-600 p-8 rounded-3xl text-white text-center">
              <h3 className="font-black text-xl mb-2">
                Siap Meningkatkan Skor?
              </h3>
              <p className="text-indigo-100 text-sm mb-5">
                Lakukan asesmen berikutnya dan lihat perkembangan Anda
              </p>
              <button
                onClick={() => router.push('/assessment')}
