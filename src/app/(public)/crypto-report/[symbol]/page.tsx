        ...
        {history.length === 0 ? (
           ...
           <div className="relative ml-4 md:ml-8 space-y-12 pb-8">
             ...
             {history.map((item, idx) => {
               ...
               let cardColor = "from-slate-500/10 to-transparent border-slate-200/50 dark:border-slate-800/50";
               let iconColor = "bg-slate-500 text-white shadow-slate-200/50";
               let badgeColor = "bg-slate-100/50 text-slate-700 border-slate-300/50 dark:bg-slate-800/50 dark:text-slate-300";
               let glowColor = "bg-slate-500/20";
               
               if (isScalp) {
                  cardColor = "from-orange-500/10 to-transparent border-orange-200/50 dark:border-orange-900/50";
                  iconColor = "bg-gradient-to-br from-orange-400 to-orange-600 text-white shadow-orange-500/30";
                  badgeColor = "bg-orange-100/50 text-orange-700 border-orange-300/50 dark:bg-orange-500/10 dark:text-orange-400";
                  glowColor = "bg-orange-500/30";
               } else if (isBuy) {
                  cardColor = "from-emerald-500/10 to-transparent border-emerald-200/50 dark:border-emerald-900/50";
                  iconColor = "bg-gradient-to-br from-emerald-400 to-emerald-600 text-white shadow-emerald-500/30";
                  badgeColor = "bg-emerald-100/50 text-emerald-700 border-emerald-300/50 dark:bg-emerald-500/10 dark:text-emerald-400";
                  glowColor = "bg-emerald-500/30";
               } else if (isSell) {
                  cardColor = "from-rose-500/10 to-transparent border-rose-200/50 dark:border-rose-900/50";
                  iconColor = "bg-gradient-to-br from-rose-400 to-rose-600 text-white shadow-rose-500/30";
                  badgeColor = "bg-rose-100/50 text-rose-700 border-rose-300/50 dark:bg-rose-500/10 dark:text-rose-400";
               ...
               return (
                 <div key={idx} className="relative pl-10 md:pl-14 group">
                    ...
                    <div className="absolute left-0 top-5 flex items-center justify-center w-8 h-8 -ml-0.5 z-20">
                       ...
                       <div className={`relative w-8 h-8 rounded-full ${iconColor} flex items-center justify-center shadow-lg border-2 border-white dark:border-slate-950 z-10`}>
                    ...
                    <Card className={`overflow-hidden rounded-2xl border bg-gradient-to-br bg-white/40 dark:bg-slate-900/40 backdrop-blur-md shadow-[0_4px_20px_rgb(0,0,0,0.03)] transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5 ${cardColor}`}>
                       <div className="p-5 md:p-6 border-b border-current/10 flex flex-col sm:flex-row justify-between sm:items-center gap-3 relative">
                         ...
                         <div className="relative z-10">
                            <div className="flex flex-wrap items-center gap-3 mb-2">
                               ...
                               <span className="text-xs text-slate-500 dark:text-slate-400 font-medium flex items-center gap-1.5 bg-white/60 dark:bg-slate-900/60 px-2 py-0.5 rounded-full border border-slate-200/50 dark:border-slate-800/50 shadow-sm">
                       ...
                       <div className="p-5 md:p-6 flex flex-col xl:flex-row xl:items-stretch justify-between gap-6 relative z-10">
                           ...
                           <div className="flex flex-col sm:flex-row xl:flex-col items-center xl:items-end justify-center gap-4 xl:w-[28rem] shrink-0 border-t xl:border-t-0 xl:border-l border-current/10 pt-6 xl:pt-0 xl:pl-6">
                              <div className="grid grid-cols-2 gap-3 text-xs w-full bg-white/80 dark:bg-slate-950/80 p-4 rounded-xl border border-current/20 shadow-inner text-left">
                                 {isScalp ? (
                                   <>
