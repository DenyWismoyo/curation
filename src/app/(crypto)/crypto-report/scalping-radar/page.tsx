  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-10 space-y-12">
        ...
        {/* HERO SECTION */}
        <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-orange-500/20 bg-black">
          <div className="absolute inset-0 bg-gradient-to-br from-orange-950/40 via-black to-slate-900"></div>
          ...
          <div className="relative z-10 p-8 md:p-12">
             ...
             <div className="flex flex-wrap items-center gap-4">
                <div className="bg-white/5 backdrop-blur-md rounded-2xl px-6 py-4 border border-white/5 flex items-center gap-4">
                   <Activity className="w-8 h-8 text-orange-400" />
                   <div>
                     <div className="text-xs text-slate-500 uppercase font-bold tracking-widest">Active Setups</div>
                     <div className="text-2xl font-black text-white">{scalps.length}</div>
                   </div>
                </div>
             </div>
          </div>
        ...
        <div className="space-y-6">
           {scalps.length === 0 ? (
             <div className="text-center p-12 border border-dashed border-slate-800 rounded-3xl">
                <ShieldAlert className="w-12 h-12 text-slate-600 mx-auto mb-4" />
                <h3 className="text-lg font-bold text-slate-400">Tidak ada setup yang lolos uji risiko saat ini.</h3>
             </div>
           ) : (
             scalps.map((scalp: any, idx: number) => (
               <Card key={idx} className="bg-slate-900/40 border-slate-800/60 backdrop-blur-md overflow-hidden transition-all duration-500 hover:border-orange-500/30 hover:bg-slate-900/80 hover:shadow-[0_0_30px_rgba(249,115,22,0.05)] group">
                   ...
                   <div className="lg:w-1/3 flex flex-col justify-between relative">
                      ...
                      <div className="relative z-10">
                         <div className="flex items-center gap-3 mb-6">
                            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center border border-slate-700 shadow-inner">
                              <span className="font-black text-lg text-white">{scalp.symbol.replace("USDT", "")}</span>
                            </div>
                            <div>
                         ...
                         <div className="space-y-4 mb-6">
                            <div className="bg-black/40 rounded-xl p-4 border border-white/5 flex justify-between items-center">
                               ...
                               <span className="font-mono text-lg font-bold text-white">${scalp.entryPrice}</span>
                            </div>
                            <div className="bg-emerald-950/20 rounded-xl p-4 border border-emerald-900/30 flex justify-between items-center">
                            ...
                            <div className="bg-rose-950/20 rounded-xl p-4 border border-rose-900/30 flex justify-between items-center">
                      ...
                      <div className="pt-4 border-t border-slate-800/50 flex justify-between items-center relative z-10">
                         ...
                         <div className="text-sm font-black text-slate-300 bg-slate-800/50 px-3 py-1 rounded-md">{scalp.riskRewardRatio}</div>
                      </div>
                   </div>

                   {/* RIGHT: DEEP THESIS */}
                   <div className="lg:w-2/3 border-t lg:border-t-0 lg:border-l border-slate-800/50 pt-6 lg:pt-0 lg:pl-8 flex flex-col">
                      <div className="mb-6 flex items-center gap-2">
                         <BarChart3 className="w-5 h-5 text-indigo-400" />
                         <h4 className="text-lg font-bold text-white tracking-tight">AI Multi-Agent Thesis</h4>
                      </div>
                      <div className="bg-black/20 rounded-2xl p-6 border border-white/5 flex-1 shadow-inner">
                      ...
                      <div className="mt-6 flex items-center justify-between">
                         <div className="flex items-center gap-2 text-xs text-slate-500 font-medium">
                            ...
                            Alokasi yang disarankan: <span className="font-bold text-slate-300">{scalp.allocationPercentage}</span>
                         </div>
