    ...
    <div className="min-h-screen bg-[#FAFAFA] px-6 py-10 lg:px-12">
      <article className="max-w-4xl mx-auto bg-white rounded-3xl ring-1 ring-slate-200 shadow-sm p-6 md:p-10 space-y-6">
        <header className="space-y-2">
          <p className="text-xs uppercase tracking-widest font-black text-indigo-600">Kebijakan Privasi</p>
          <h1 className="text-3xl md:text-4xl font-black text-slate-900">Kebijakan Privasi Omnifit</h1>
        ...
        <section className="space-y-2">
          <h2 className="text-xl font-black text-slate-900">Data yang Kami Kumpulkan</h2>
        ...
        <section className="space-y-2">
          <h2 className="text-xl font-black text-slate-900">Tujuan Penggunaan Data</h2>
          <ul className="space-y-2 text-slate-700">
        ...
        <section className="space-y-2">
          <h2 className="text-xl font-black text-slate-900">Perlindungan Data</h2>
        ...
        <section className="space-y-2">
          <h2 className="text-xl font-black text-slate-900">Hak Pengguna</h2>
