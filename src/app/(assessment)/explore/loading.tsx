    ...
    <div className="min-h-screen bg-[#FAFAFA] animate-pulse pb-24 pt-24">
      <div className="max-w-6xl mx-auto px-6 lg:px-12 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-4 mb-8">
           <div className="h-12 w-full sm:w-72 bg-white rounded-xl border border-slate-100/60 shadow-sm" />
        ...
        <div className="bg-white rounded-[2.5rem] border border-slate-100/60 shadow-sm p-6 sm:p-8 mb-12">
           <div className="w-full aspect-[2/1] bg-slate-100 rounded-[2rem] mb-8" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {[...Array(8)].map((_, i) => (
            <div key={i} className="bg-white rounded-[1.5rem] border border-slate-100/60 shadow-sm overflow-hidden flex flex-col">
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <div className="h-4 w-4/5 bg-slate-100 rounded-lg mt-auto" />
              </div>
            </div>
          ))}
        </div>
