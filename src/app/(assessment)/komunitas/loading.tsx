    ...
    <div className="min-h-screen bg-background text-foreground animate-pulse">
      ...
      <div className="bg-gradient-to-br from-indigo-600 to-purple-700 pt-12 pb-10 px-5">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="h-8 w-52 card-solid/20 rounded mb-2" />
          <div className="h-4 w-40 card-solid/20 rounded" />
        </div>
      </div>
      ...
      <div className="px-5 py-5 grid grid-cols-2 gap-3 max-w-3xl mx-auto">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="h-20 card-solid rounded-2xl border border-border shadow-sm" />
        ))}
      </div>
      ...
      <div className="px-5 max-w-3xl mx-auto space-y-2">
        {[...Array(8)].map((_, i) => (
          <div key={i} className="h-14 card-solid rounded-2xl border border-border shadow-sm" />
        ))}
      </div>
    </div>
  );
