...
import { 
  ...
  Activity, Lightbulb, Target, Package, Banknote, 
  ShieldCheck, ListChecks, CheckSquare, Route, ChevronDown
} from 'lucide-react';
...
// Komponen Akordeon untuk Insight Rekomendasi
...
export function AdminAssessmentDetail({ data, onClose }: AdminAssessmentDetailProps) {
  // Tab aktif (Input Form vs Hasil AI)
  ...
  // Persiapan data untuk Radar Chart AI
  const radarData = aiResult?.radarMetrics ? [
  ...
  // Helper memformat "camelCase" ke "Camel Case" untuk label dinamis
            ...
            <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded-[2rem] ring-1 ring-slate-200 shadow-sm flex flex-col items-center">
                  <h4 className="font-black text-slate-900 mb-4 text-center text-lg tracking-tight">Analisis 6 Dimensi</h4>
                  <div className="w-full h-[300px] relative -ml-2">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 p-6 bg-white ring-1 ring-slate-200 rounded-[2rem] shadow-sm">
                  ...
                  <div className="flex flex-col gap-3">
                    <InsightAccordion id="market" title="Strategi Go-To-Market" icon={Target} content={aiResult.recommendations?.goToMarketStrategy} expandedSection={expandedSection} setExpandedSection={setExpandedSection} />
                    <InsightAccordion id="product" title="Product Roadmap" icon={Package} content={aiResult.recommendations?.productRoadmap} expandedSection={expandedSection} setExpandedSection={setExpandedSection} />
                    <InsightAccordion id="finance" title="Optimasi Finansial" icon={Banknote} content={aiResult.recommendations?.financialOptimization} expandedSection={expandedSection} setExpandedSection={setExpandedSection} />
                    <InsightAccordion id="investment" title="Kesiapan Investasi" icon={ShieldCheck} content={aiResult.recommendations?.investmentReadiness} expandedSection={expandedSection} setExpandedSection={setExpandedSection} />
                  </div>
                </div>
                ...
                <div className="lg:col-span-1 flex flex-col gap-6">
                  ...
                  <div className={`p-6 rounded-[2rem] text-center ring-1 shadow-sm ${isHighTier ? 'bg-emerald-50 ring-emerald-200 text-emerald-900' : 'bg-indigo-50 ring-indigo-200 text-indigo-900'}`}>
                    ...
                    <h4 className="text-xl font-black leading-tight tracking-tight text-balance">{aiResult.recommendations?.incubationRoute}</h4>
                  </div>
