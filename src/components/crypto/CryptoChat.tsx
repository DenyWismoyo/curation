        ...
        <SheetHeader className="px-6 py-4 bg-indigo-950/50 border-b border-indigo-900/50 text-white space-y-0.5 relative z-10 shadow-md backdrop-blur-md">
          <div className="flex justify-between items-start">
            ...
            <div className="flex items-center gap-1">
               <Button variant="ghost" size="icon" className="text-white hover:bg-white/20 h-8 w-8 rounded-full" onClick={startNewChat} title="Chat Baru">
                  <Plus className="w-4 h-4" />
               </Button>
               <Button variant="ghost" size="icon" className="text-white hover:bg-white/20 h-8 w-8 rounded-full" onClick={() => setView(view === 'chat' ? 'history' : 'chat')} title="Riwayat">
                  {view === 'chat' ? <Clock className="w-4 h-4" /> : <MessageSquare className="w-4 h-4" />}
               </Button>
               <Button variant="ghost" size="icon" className="text-white hover:bg-white/20 h-8 w-8 rounded-full ml-1" onClick={onClose}>
                  <X className="w-4 h-4" />
               </Button>
            </div>
          </div>
