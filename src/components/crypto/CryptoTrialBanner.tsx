...
export default function CryptoTrialBanner() {
  ...
  return (
    <div className={`relative z-50 flex items-center justify-between px-4 py-2 sm:px-6 shadow-md transition-colors duration-500 ${isWarning ? 'bg-rose-950/80 border-b border-rose-900' : 'bg-emerald-950/80 border-b border-emerald-900'}`}>
      <div className="flex items-center gap-3">
        ...
        <div className="text-xs sm:text-sm text-slate-200">
          <span className="font-bold text-white mr-1">Trial Premium Aktif:</span>
      ...
      <div className="flex items-center gap-4">
        <button 
          ...
          className={`text-xs font-bold px-3 py-1.5 rounded-md transition-all ${isWarning ? 'bg-rose-600 hover:bg-rose-500 text-white shadow-[0_0_10px_rgba(225,29,72,0.3)]' : 'bg-emerald-600 hover:bg-emerald-500 text-white shadow-[0_0_10px_rgba(16,185,129,0.3)]'}`}
        >
          Upgrade Sekarang
        </button>
