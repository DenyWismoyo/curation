        ...
        <div className="max-w-7xl mx-auto space-y-6 sm:space-y-8 animate-in fade-in zoom-in-95 duration-300 pb-24">
          ...
          <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4 card-solid p-4 sm:p-6 rounded-3xl ring-1 ring-border shadow-sm sticky top-4 z-40 w-full">
            <div className="flex items-center gap-4">
              <Button variant="ghost" onClick={onClose} className="w-10 h-10 p-0 rounded-full bg-muted text-muted-foreground hover:bg-slate-200 text-muted-foreground shrink-0">
                <X size={20} />
              </Button>
              <div>
